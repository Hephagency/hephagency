    ...
    return (
        <section className="overflow-hidden w-full h-dvh flex flex-col justify-center items-center bg-white">
            <div className="relative max-w-full flex justify-center items-center max-h-full">
                ...
                <HomeSplineScene/>
                <h2 className="h5 text-grey-dark md:h4 absolute bottom-0 left-0 xl:left-24 xl:bottom-24 w-full px-4 md:px-6 xl:px-7.5 z-30 invert mix-blend-difference max-w-131 md:max-w-140">

    ...
    return (
        <section className={clsx(
            ...
            <div className="h-full flex flex-col-reverse xl:flex-col xl:justify-center xl:items-center relative xl:w-fit xl:h-fit xl:py-32">
                <h1 className="grow basis-0 h4 flex flex-col justify-center xl:grow-0 xl:h2">
                    <span className="xl:absolute xl:top-0 xl:left-0 xl:-translate-x-full">
                        {translations.home_landing_title_first[hephagency_config.language]}
                    </span>
                    <span className="xl:absolute xl:bottom-0 xl:right-0 xl:translate-x-full">

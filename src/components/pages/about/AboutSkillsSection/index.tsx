...
export default function AboutSkillsSection() {
    return (
        <section className={clsx(
            "relative bg-red-500 w-full h-dvh relative text-grey-dark flex flex-col py-14 overflow-hidden",
            ...
            <div className="px-4 md:px-6 xl:px-7.5 grow basis-0 flex flex-col justify-center items-end">
                <p className="paragraph-p md:paragraph-large text-end md:max-w-150 xl:max-w-225">

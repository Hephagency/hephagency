    ...
    return (
        <ul className="flex flex-wrap gap-2 md:gap-5">
            ...
            <li key={index}>
                <MenuLink
                {...link}
                className="paragraph-small active:opacity-25 transition-all relative after:content-[''] after:absolute after:-bottom-1.5 after:left-0 after:w-full after:h-[1px] after:bg-grey-light hover:after:bg-grey-light hover:after:scale-x-100 after:scale-x-0 after:transition-transform after:origin-left after:duration-500"
                />
            </li>
            )}
